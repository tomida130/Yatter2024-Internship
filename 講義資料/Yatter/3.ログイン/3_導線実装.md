...
ログイン画面の導線実装に入る前に、まずJetpack Composeでの画面遷移の方法を学びましょう。Jetpack Composeでは画面遷移に[navigation-compose](https://developer.android.com/develop/ui/compose/navigation?hl=ja)を使うことが多いです。
